...
For developers working with this repository, see the [dev-config](dev-config/) directory for Qoder IDE configuration files that optimize tool usage and parallel execution capabilities.
